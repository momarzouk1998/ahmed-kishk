...
export const BUILT_IN_BRAND: BrandSettings = {
  storeName: 'مؤسسة كشك للأقمشة والستائر',
  subTitle: 'الفرع الرئيسي: 73 شارع سعد زغلول والجامع العباسي',
  phone: '01063821000',
  whatsapp: '201063821000',
  address: '73 شارع سعد زغلول والجامع العباسي',
  footerNote: 'شكراً لتعاملكم مع مؤسسة كشك لتجارة الأقمشة والستائر. البضاعة المباعة لا ترد ولا تستبدل بعد أسبوع. جميع الحقوق محفوظة.',
};
